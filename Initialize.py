...
# Cant be bothered to figure out how to covert this to the new pip, but this doesn't work

#required = ['gmusicapi', 'validators', 'pytube', 'python-vlc', 'xlsxwriter']
#installed = [pkg.key for pkg in pip._internals.get_installed_distributions()]
